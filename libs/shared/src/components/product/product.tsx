...
export const Product = component$<Props>(({ product }) => {
  return (
    <div class="m-4 w-[300px] rounded-lg border border-gray-700 bg-white shadow">
      <a href="libs/shared/src/lib#">
        <img
          class="cover mx-auto h-[300px] w-[300px] rounded-t-lg p-8"
          height="300"
          width="300"
          src={product.image}
          alt={product.title}
      ...
      <div class="px-5 pb-5">
        <a href="libs/shared/src/lib#">
          <h5 class=" truncate text-xl font-semibold tracking-tight text-black">
            {product.title}
          </h5>
        </a>
