...
import { CheckoutContext } from '~shared'
      ...
      <div class="mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mt-8 max-w-2xl">
          <div class="bg-white  p-4">
            ...
            <div class="">
              ...
              <div class="flex flex-col sm:flex-row">
                ...
                <input
                  type="text"
                  name="billing-zip"
                  class="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500 sm:w-1/6"
                  placeholder="ZIP"
                />
              </div>
            ...
            <button
              class="group inline-flex w-full items-center justify-center rounded-md bg-gray-900 px-6 py-4 text-lg font-semibold text-white transition-all duration-200 ease-in-out hover:bg-gray-800 focus:shadow"
              onClick$={() => {
